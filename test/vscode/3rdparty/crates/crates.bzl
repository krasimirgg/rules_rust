...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "serde": Label("@rtvsc//serde-1.0.229"),
            "serde_json": Label("@rtvsc//serde_json-1.0.151"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        crates_module = Label("//test/vscode/3rdparty/crates:crates.bzl"),
    )
    maybe(
        http_archive,
    ...
    maybe(
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.memchr-2.8.3.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__proc-macro2-1.0.107",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.proc-macro2-1.0.107.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__quote-1.0.47",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.quote-1.0.47.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde-1.0.229",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde-1.0.229.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde_core-1.0.229",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde_core-1.0.229.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde_derive-1.0.229",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde_derive-1.0.229.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde_json-1.0.151",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde_json-1.0.151.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__syn-3.0.3",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.syn-3.0.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.zmij-1.0.23.bazel"),
    )

    return [
        struct(repo = "rtvsc", is_dev_dep = False),
        struct(repo = "rtvsc__serde-1.0.229", is_dev_dep = False),
        struct(repo = "rtvsc__serde_json-1.0.151", is_dev_dep = False),
    ]
