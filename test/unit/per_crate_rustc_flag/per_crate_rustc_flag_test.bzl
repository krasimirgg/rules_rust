...
per_crate_rustc_flag_not_present_non_matching_test = analysistest.make(
    ...
    config_settings = {
        str(Label("//rust/settings:per_crate_rustc_flag")): [NON_MATCHING_FLAG],
    },
)
...
per_crate_rustc_flag_present_label_test = analysistest.make(
    ...
    config_settings = {
        str(Label("//rust/settings:per_crate_rustc_flag")): [MATCHING_LABEL_FLAG],
    },
)
...
per_crate_rustc_flag_present_execution_path_test = analysistest.make(
    ...
    config_settings = {
        str(Label("//rust/settings:per_crate_rustc_flag")): [MATCHING_EXECUTION_PATH_FLAG],
    },
)
...
per_crate_rustc_flag_invalid_pattern_test = analysistest.make(
    ...
    expect_failure = True,
    config_settings = {
        str(Label("//rust/settings:per_crate_rustc_flag")): [INVALID_FLAG],
    },
)
